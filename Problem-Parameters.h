...
//-------------------------- Compilation Modes -----------------------
//#define PP_DEBUG
#define PP_PATH "C:/Users/nikolay/source/MTXPacketConverter/test_50000_60/"
...
#define PP_BLOCK_OBJ_VARIABLE		true	// straightens the trace, but can lead to an incorrect solution
//------------------------------------------------------------------/**/
/**#define PP_PROBLEM_NAME		"generator" //==========================================
...
#define PP_MAX_ITER_COUNT				4000 // Maximal count of iterations
