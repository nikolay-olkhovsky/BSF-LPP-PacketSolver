...
#define PP_EPS_OBJECTIVE			1E-6	// < |F(u)-F(w)|
...
#define PP_EPS_COMPARE				1E-5	// Comparison precision
#define PP_EPS_DIR					1E-5	// Minimal Length of Direction Vector
...
/**#define PP_MTX_PROBLEM_NAME		"blend"	// 30.812; 8 nodes
#define PP_M 74		// Number of equations (number of rows in *.mtx)
#define PP_N 114	// Number of variables (number of cols in *.mtx)
//------------------------------------------------------------------
#define PP_EPS_RELAX				1E-10	// Precision for relaxation
#define PP_EPS_IN					1E-1	// Minimal distance to polytope (not too small!!!)
#define PP_EPS_SHIFT				1E-7	// Minimal shift
#define PP_EPS_ZERO					1E-7	// Accuracy of zero value
#define PP_EPS_COMPARE				1E-7	// Comparison precision
#define PP_EPS_DIR					1E-7	// Minimal Length of Direction Vector
